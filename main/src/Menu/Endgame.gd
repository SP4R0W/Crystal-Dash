...
func check_for_highscore():
	for x in range(1,11):
		# When we find a new highscore move all the previous scores lower and remove the 11th one. Then replace the slot with a new highscore.
