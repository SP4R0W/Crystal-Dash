...
const score_table = {3:100,4:250,5:500,6:1000,7:2500,8:5000}
const time_table = {3:0.25,4:0.5,5:1,6:1.5,7:2,8:3}
...
func remove_board(restore,gameover=false):
	...
	var board_seed = Seeds.seeds[(randi() % Seeds.seeds.size()) - 1]
